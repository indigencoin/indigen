...
This mechanism has been integrated into Bitcore-Node-Indigen which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/indigen/insight-api-indigen#web-socket-api](https://github.com/indigen/insight-api-indigen#web-socket-api)
* API: [https://github.com/indigen/insight-api-indigen#swifttx-transactions](https://github.com/indigen/insight-api-indigen#swifttx-transactions)
...
By default, the Indigen Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Indigen Core daemon:
