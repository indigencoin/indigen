...
In order to support loading of multiple wallets in indigen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is indigen.cpp.
...
Changes to indigen.cpp
----------------------
indigen.cpp is the entry point into indigen-qt, and as such, will require some minor modifications to provide hooks for
