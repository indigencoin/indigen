...
Intro
-----
Indigen (IDG) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Indigen utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run indigen-qt.exe.

Indigen Core is the original Indigen client and it builds the backbone of the network.
However, it downloads and stores the entire history of Indigen transactions;
