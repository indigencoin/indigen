...
#   c) node1 mines 32 blocks, so now node 0 has 500000IDG, node 1 has 4250IDG, node2 has none.
#   d) node0 sends 601 IDG to node2, in two transactions (301 IDG, then 300 IDG).
