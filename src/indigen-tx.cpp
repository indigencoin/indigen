...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Indigen Core indigen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  indigen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded indigen transaction") + "\n" +
                               "  indigen-tx [options] -create [commands]   " + _("Create hex-encoded indigen transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded indigen transaction
