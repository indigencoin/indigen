...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Indigen server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Indigen features */
        {"indigen", "masternode", &masternode, true, true, false},
        {"indigen", "listmasternodes", &listmasternodes, true, true, false},
        {"indigen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"indigen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"indigen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"indigen", "masternodedebug", &masternodedebug, true, true, false},
        {"indigen", "startmasternode", &startmasternode, true, true, false},
        {"indigen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"indigen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"indigen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"indigen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"indigen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"indigen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"indigen", "mnbudget", &mnbudget, true, true, false},
        {"indigen", "preparebudget", &preparebudget, true, true, false},
        {"indigen", "submitbudget", &submitbudget, true, true, false},
        {"indigen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"indigen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"indigen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"indigen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"indigen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"indigen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"indigen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"indigen", "checkbudgets", &checkbudgets, true, true, false},
        {"indigen", "mnsync", &mnsync, true, true, false},
        {"indigen", "spork", &spork, true, true, false},
        {"indigen", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"indigen", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"indigen", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"indigen", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"indigen", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"indigen", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> indigen-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10018/\n";
}
