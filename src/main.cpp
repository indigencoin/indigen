...
#if defined(NDEBUG)
#error "Indigen cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < Params().LAST_POW_BLOCK())
        ...
        nSubsidy = 17 * COIN;
    else if (nHeight > 1700000 && nHeight <= 3400000)
        nSubsidy = 8.5 * COIN;
    else if (nHeight > 3400000 && nHeight <= 5100000)
        nSubsidy = 4.25 * COIN;
    else if (nHeight > 5100000 && nHeight <= 6800000)
        nSubsidy = 2.125 * COIN;
    else if (nHeight > 6800000 && nHeight <= 8500000)
        nSubsidy = 1.0625 * COIN;
    else if (nHeight > 8500000 && nHeight <= 10200000)
        nSubsidy = 0.53125 * COIN;
    else
        nSubsidy = 0.265625 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // IDG: We use certain sporks during IBD, so check to see if they are
