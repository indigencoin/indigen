                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Indigen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IDG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and indigen: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Indigen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Indigen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Indigen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IDG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IDG addresses"));
    ...
    openAction->setStatusTip(tr("Open a indigen: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Indigen Core help message to get a list with possible Indigen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Indigen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Indigen network", "", count));
}
...
{
    QString strTitle = tr("Indigen Core"); // default title
