...
/** Utility functions used by the Indigen Qt UI.
 */
namespace GUIUtil
{
...
// Render IDG addresses in monospace font
...
// Parse "indigen:" URI into recipient object, return true on successful parsing
