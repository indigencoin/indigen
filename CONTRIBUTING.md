Contributing to Indigen Core
==================================

The Indigen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Indigen Core project, and is not to be
confused with overall Indigen Network Protocol consensus changes.

Whether a pull request is merged into Indigen Core rests with the project merge
...
Patches that change Indigen consensus rules are considerably more involved than
...
Where a patch set proposes to change the Indigen consensus, it must have been
...
The project leader is the release manager for each Indigen Core release.
