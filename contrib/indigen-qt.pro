...
RESOURCES += src/qt/indigen.qrc src/qt/indigen_locale.qrc

TRANSLATIONS += src/qt/locale/indigen_bg.ts \
                src/qt/locale/indigen_de.ts \
                src/qt/locale/indigen_en.ts \
                src/qt/locale/indigen_es.ts \
                src/qt/locale/indigen_fi.ts \
                src/qt/locale/indigen_fr.ts \
                src/qt/locale/indigen_it.ts \
                src/qt/locale/indigen_ja.ts \
                src/qt/locale/indigen_pl.ts \
                src/qt/locale/indigen_pt.ts \
                src/qt/locale/indigen_ru.ts \
                src/qt/locale/indigen_sk.ts \
                src/qt/locale/indigen_sv.ts \
                src/qt/locale/indigen_vi.ts \
                src/qt/locale/indigen_zh_CN.ts \
                src/qt/locale/indigen_zh_TW.ts
